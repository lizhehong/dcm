...
public class TcpLqmdbDecoder extends TcpDecoder  {
	...
	public TcpLqmdbDecoder(NettyBoot nettyBoot, List<DataTab> dataTabs, CommTypeConvert convert) {
		super(logger, nettyBoot, new DataTcpDecoder<ByteBuf>(new LqmdbDecoder(dataTabs, convert)));
	}
}
